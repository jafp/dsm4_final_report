...
\def\ThTitleEN{Speech Coding - Final Project in DSM4}
\def\ThSubtitleEN{Digital Signal Processing and Mathematics 4}
...
\def\ThSupervisors{John Kryger Soerensen, DTU Ballerup Campus}
...
\def\ThCopyrights{\copyright Andre D. B. Christensen \& Jacob A. F. Pedersen, 2013}
